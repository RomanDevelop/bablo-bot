/// Bablo Telegram Mini App auth constants.
class AuthConstants {
  AuthConstants._();
  ...
  static const outsideTelegramBody =
      'Bablo cabinet auth works inside the Telegram Mini App. '
      'Open @Artem_Bablo_Bot and tap the menu button to launch Bablo Trading.';
}
