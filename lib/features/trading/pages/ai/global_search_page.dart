...
class _GlobalSearchPageState extends State<GlobalSearchPage> {
  ...
  static const _entries = <_SearchEntry>[
    ...
    _SearchEntry('Courses', 'Менторинг', AppRoutes.courses, Icons.school_outlined),
    _SearchEntry('Alexander L.', 'Chief Crypto Guru', AppRoutes.courseAlexanderL, Icons.person_outline_rounded),
    _SearchEntry('Anton "THE FED"', 'Launch & tokenomics', AppRoutes.courseAntonTheFed, Icons.token_outlined),
